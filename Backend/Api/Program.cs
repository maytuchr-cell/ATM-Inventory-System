...
using (var scope = app.Services.CreateScope())
{
    ...
    try
    {
        ...
        if (isSqlite) try
        {
            context.Database.ExecuteSqlRaw(@"
                CREATE TABLE IF NOT EXISTS TicketAttachments (
                    TicketAttachmentId INTEGER NOT NULL CONSTRAINT PK_TicketAttachments PRIMARY KEY AUTOINCREMENT,
                    TicketId INTEGER NOT NULL,
                    Phase TEXT NOT NULL,
                    FilePath TEXT NOT NULL,
                    FileName TEXT NOT NULL,
                    UploadedAt TEXT NOT NULL,
                    CONSTRAINT FK_TicketAttachments_Tickets FOREIGN KEY (TicketId) REFERENCES Tickets (TicketId) ON DELETE CASCADE
                );");
            context.Database.ExecuteSqlRaw(
        ...
        if (isSqlite) try
        {
            ...
            if (!ticketCols.Contains("TechSupportName"))
            {
                context.Database.ExecuteSqlRaw("ALTER TABLE Tickets ADD COLUMN TechSupportName TEXT NULL;");
                Console.WriteLine("✅ Migration: added Tickets.TechSupportName");
            }
            if (!ticketCols.Contains("EmailSentAt"))
            {
                context.Database.ExecuteSqlRaw("ALTER TABLE Tickets ADD COLUMN EmailSentAt TEXT NULL;");
                Console.WriteLine("✅ Migration: added Tickets.EmailSentAt");
            }
            if (!ticketCols.Contains("ReturnEmailSentAt"))
            {
        ...
        // ── Backfill Part.Zone (Upper/Lower) for existing DBs seeded before this field existed.
        //    Only the parts confirmed by the GRG catalog's "Sub Unit" = "Upper Unit"/"Lower Unit"
        //    column — everything else stays null (unknown) rather than guessed. Idempotent:
        //    only touches rows where Zone is still unset. ──
        try
        {
            var zoneByPartNo = new Dictionary<string, string>
            {
                ["502010237004"]="Upper", ["725030904002"]="Upper", ["502010237002"]="Upper",
                ["502010227002"]="Lower", ["301010117"]="Lower", ["301010117-H"]="Lower",
                ["301010339"]="Lower", ["301010339-H"]="Lower", ["402020038"]="Lower",
                ["402020038-H"]="Lower", ["502010742"]="Lower", ["502010743"]="Lower",
                ["502010744"]="Lower", ["502010810"]="Lower", ["711060008"]="Lower",
                ["502011091-H"]="Lower", ["502011455-H"]="Lower", ["502011088-H"]="Lower",
                ["502011089-H"]="Lower", ["502011090-H"]="Lower", ["401010890-H"]="Lower",
                ["502011093-H"]="Lower", ["401010892-H"]="Lower", ["401010894-H"]="Lower",
                ["301010145-H"]="Lower", ["401010898-H"]="Lower", ["711060005-H"]="Lower",
                ["502011457-H"]="Lower", ["502011649-H"]="Lower", ["502011450-H"]="Lower",
                ["502011092-H"]="Lower", ["502011454-H"]="Lower", ["502011094-H"]="Lower",
                ["401010896-H"]="Lower", ["401010890"]="Lower", ["401010892"]="Lower",
                ["401010894"]="Lower", ["401010896"]="Lower", ["401010898"]="Lower",
                ["502011091"]="Lower", ["502011090"]="Lower", ["502011089"]="Lower",
                ["502011088"]="Lower",
            };
            var toBackfill = context.Parts
                .Where(p => zoneByPartNo.Keys.Contains(p.PartNo) && p.Zone == null)
                .ToList();
            foreach (var p in toBackfill) p.Zone = zoneByPartNo[p.PartNo];
            if (toBackfill.Count > 0)
            {
                context.SaveChanges();
                Console.WriteLine($"✅ Backfilled Part.Zone for {toBackfill.Count} part(s).");
            }
        }
        catch (Exception mex) { Console.WriteLine($"⚠ Part.Zone backfill skipped: {mex.Message}"); }

        // ── Backfill Part.DeviceType (ATM/ADM/CDM) for existing DBs seeded before this field
        //    existed. Parsed from the GRG catalog's free-text "Remark" column (e.g.
        //    "ADM,GHB,BOC,VTM" -> "ADM"); comma-combo when a part serves more than one type.
        //    Everything else stays null (not mentioned) rather than guessed. Idempotent. ──
        try
        {
            var deviceTypeByPartNo = new Dictionary<string, string>
            {
                ["202020228"]="ADM", ["202030012001-H"]="ADM", ["202030464"]="ADM",
                ["206010182018"]="ADM", ["206010182018-H"]="ADM", ["207040007005-H"]="CDM",
                ["207040197"]="ADM", ["208010006-H"]="CDM", ["208010063-H"]="CDM",
                ["208010065-H"]="CDM", ["211010195-H"]="ADM", ["211010253"]="ADM",
                ["211010408"]="ADM", ["214010191001"]="ADM", ["214010191002"]="ADM",
                ["214020210"]="ADM", ["214020210-H"]="ADM", ["214020393"]="ADM,ATM",
                ["214020503-GA"]="ATM", ["214020527-GA"]="ATM", ["214020669"]="ATM",
                ["214030189"]="ATM", ["215040005-H"]="CDM", ["215050240"]="ADM",
                ["215050240-GA"]="CDM", ["216020190"]="ADM", ["301010116"]="ADM",
                ["301010116-H"]="ADM", ["301010117"]="ADM", ["301010117-H"]="ADM",
                ["301010339-H"]="ADM", ["301010904"]="ADM", ["301011993"]="ADM",
                ["301011994"]="ADM", ["3101173TE-1K"]="CDM", ["502010216"]="ADM",
                ["502010216-H"]="ADM", ["502010216001"]="ADM", ["502010217"]="ADM",
                ["502010217-H"]="ADM", ["502010218003"]="ADM", ["502010223"]="ADM",
                ["502010223001"]="ADM", ["502010223001-H"]="ADM", ["502010223002"]="ADM",
                ["502010237002"]="ADM", ["502010237004"]="ADM", ["502010284"]="ADM",
                ["502010284-H"]="ADM", ["502010292002-H"]="CDM", ["502010798"]="ADM",
                ["502010798-H"]="ADM", ["502010799"]="ADM", ["502010799-H"]="ADM",
                ["502011423-H"]="ADM", ["502011424-H"]="ADM", ["502011508002-H"]="ADM",
                ["502011510-H"]="ADM", ["502011535-H"]="ADM", ["502011938-H"]="ATM",
                ["502015969"]="ADM", ["502017581"]="ADM", ["502018807"]="ADM",
                ["502021657"]="ADM", ["711010513"]="ADM", ["725030904002"]="ADM",
                ["726010353-H"]="ADM", ["9103-53862XG1-00"]="ADM", ["AD. V030004"]="ADM",
                ["An.J V030006"]="ADM", ["B. V030001"]="ADM", ["H. V030008"]="ADM",
                ["R. V030002"]="ADM", ["SC. V030007"]="ADM", ["SP. V030005"]="ADM",
            };
            var toBackfillDt = context.Parts
                .Where(p => deviceTypeByPartNo.Keys.Contains(p.PartNo) && p.DeviceType == null)
                .ToList();
            foreach (var p in toBackfillDt) p.DeviceType = deviceTypeByPartNo[p.PartNo];
            if (toBackfillDt.Count > 0)
            {
                context.SaveChanges();
                Console.WriteLine($"✅ Backfilled Part.DeviceType for {toBackfillDt.Count} part(s).");
            }
        }
        catch (Exception mex) { Console.WriteLine($"⚠ Part.DeviceType backfill skipped: {mex.Message}"); }
        ...
        if (!context.Parts.Any())
        {
            ...
            context.Parts.AddRange(new Part[] {
                ...
                new Part { PartNo="B. V030001", PartName="BOX ALARM", CategoryId=C("Alarm"), MinStock=2, MaxStock=20, ReorderPoint=5, CostPerUnit=0, IsActive=true, DeviceType="ADM" },
                new Part { PartNo="R. V030002", PartName="REMOTE", CategoryId=C("Alarm"), MinStock=2, MaxStock=20, ReorderPoint=5, CostPerUnit=0, IsActive=true, DeviceType="ADM" },
                new Part { PartNo="AD. V030004", PartName="ADAPTER", CategoryId=C("Alarm"), MinStock=2, MaxStock=20, ReorderPoint=5, CostPerUnit=0, IsActive=true, DeviceType="ADM" },
                new Part { PartNo="SP. V030005", PartName="SPEAKER", CategoryId=C("Alarm"), MinStock=2, MaxStock=20, ReorderPoint=5, CostPerUnit=0, IsActive=true, DeviceType="ADM" },
                new Part { PartNo="An.J V030006", PartName="ANTI JUMP", CategoryId=C("Alarm"), MinStock=2, MaxStock=20, ReorderPoint=5, CostPerUnit=0, IsActive=true, DeviceType="ADM" },
                new Part { PartNo="SC. V030007", PartName="SET CABLE", CategoryId=C("Alarm"), MinStock=2, MaxStock=20, ReorderPoint=5, CostPerUnit=0, IsActive=true, DeviceType="ADM" },
                new Part { PartNo="H. V030008", PartName="HEAT", CategoryId=C("Alarm"), MinStock=2, MaxStock=20, ReorderPoint=5, CostPerUnit=0, IsActive=true, DeviceType="ADM" },
                ...
                new Part { PartNo="211010195-H", PartName="USB WDR camera DV-U3303WCP205", CategoryId=C("Camera"), MinStock=2, MaxStock=20, ReorderPoint=5, CostPerUnit=0, IsActive=true, DeviceType="ADM" },
                new Part { PartNo="211010408", PartName="GDZS-DC004-EJVL dual camera", CategoryId=C("Camera"), MinStock=2, MaxStock=20, ReorderPoint=5, CostPerUnit=0, IsActive=true, DeviceType="ADM" },
                new Part { PartNo="211010253", PartName="camera(LHT-820CM301 7B/VTM /Linhuitong)", CategoryId=C("Camera"), MinStock=2, MaxStock=20, ReorderPoint=5, CostPerUnit=0, IsActive=true, DeviceType="ADM" },
                new Part { PartNo="502018807", PartName="SANKYO-0180 EASD module", CategoryId=C("Card Reader"), MinStock=2, MaxStock=20, ReorderPoint=5, CostPerUnit=0, IsActive=true, DeviceType="ADM" },
                ...
                new Part { PartNo="502011508002-H", PartName="AC Upper Plate Assy", CategoryId=C("Cassette"), MinStock=2, MaxStock=20, ReorderPoint=5, CostPerUnit=0, IsActive=true, DeviceType="ADM" },
                new Part { PartNo="502011535-H", PartName="AC base plate assembly", CategoryId=C("Cassette"), MinStock=2, MaxStock=20, ReorderPoint=5, CostPerUnit=0, IsActive=true, DeviceType="ADM" },
                new Part { PartNo="502011510-H", PartName="AC mid-plate assembly", CategoryId=C("Cassette"), MinStock=2, MaxStock=20, ReorderPoint=5, CostPerUnit=0, IsActive=true, DeviceType="ADM" },
                ...
                new Part { PartNo="726010353-H", PartName="AC Top-plate", CategoryId=C("Cassette"), MinStock=2, MaxStock=20, ReorderPoint=5, CostPerUnit=0, IsActive=true, DeviceType="ADM" },
                ...
                new Part { PartNo="502011938-H", PartName="Note Cassette CDM8240-NC-001 (CNY100)", CategoryId=C("Cassette"), MinStock=2, MaxStock=20, ReorderPoint=5, CostPerUnit=0, IsActive=true, DeviceType="ATM" },
                ...
                new Part { PartNo="502011424-H", PartName="transport-AC Lower plate B", CategoryId=C("CT"), MinStock=2, MaxStock=20, ReorderPoint=5, CostPerUnit=0, IsActive=true, DeviceType="ADM" },
                ...
                new Part { PartNo="502011423-H", PartName="transport-AC Lower plate A", CategoryId=C("CT"), MinStock=2, MaxStock=20, ReorderPoint=5, CostPerUnit=0, IsActive=true, DeviceType="ADM" },
                ...
                new Part { PartNo="502010223002", PartName="Cash Transportation (Front service)", CategoryId=C("CT"), MinStock=2, MaxStock=20, ReorderPoint=5, CostPerUnit=0, IsActive=true, DeviceType="ADM" },
                new Part { PartNo="502010223", PartName="CT MODULE (CRM9250/RS/ENGLISH) (Front service)", CategoryId=C("CT"), MinStock=2, MaxStock=20, ReorderPoint=5, CostPerUnit=0, IsActive=true, DeviceType="ADM" },
                new Part { PartNo="502010223001", PartName="CT MODULE (CRM9250/RS/ENGLISH) (Front service)", CategoryId=C("CT"), MinStock=2, MaxStock=20, ReorderPoint=5, CostPerUnit=0, IsActive=true, DeviceType="ADM" },
                new Part { PartNo="502010223001-H", PartName="CT MODULE (CRM9250/RS/ENGLISH) (Front service)", CategoryId=C("CT"), MinStock=2, MaxStock=20, ReorderPoint=5, CostPerUnit=0, IsActive=true, DeviceType="ADM" },
                ...
                new Part { PartNo="206010182018", PartName="EPP-004 Keyboard - English and Thai", CategoryId=C("EPP"), MinStock=2, MaxStock=20, ReorderPoint=5, CostPerUnit=0, IsActive=true, DeviceType="ADM" },
                ...
                new Part { PartNo="206010182018-H", PartName="EPP-004 Keyboard - English and Thai", CategoryId=C("EPP"), MinStock=2, MaxStock=20, ReorderPoint=5, CostPerUnit=0, IsActive=true, DeviceType="ADM" },
                ...
                new Part { PartNo="202030464", PartName="Finger Printer/FPR622(HID)", CategoryId=C("Fingerprint reader"), MinStock=2, MaxStock=20, ReorderPoint=5, CostPerUnit=0, IsActive=true, DeviceType="ADM" },
                new Part { PartNo="202030012001-H", PartName="Fingerprint reader (FPR-622/V501A)", CategoryId=C("Fingerprint reader"), MinStock=2, MaxStock=20, ReorderPoint=5, CostPerUnit=0, IsActive=true, DeviceType="ADM" },
                ...
                new Part { PartNo="214010191002", PartName="IPC-014(i3/3.3G/4GM/2* 1T HD)", CategoryId=C("IPC"), MinStock=2, MaxStock=20, ReorderPoint=5, CostPerUnit=0, IsActive=true, DeviceType="ADM" },
                ...
                new Part { PartNo="214020210", PartName="Seagate ST1000DM010", CategoryId=C("IPC"), MinStock=2, MaxStock=20, ReorderPoint=5, CostPerUnit=0, IsActive=true, DeviceType="ADM" },
                new Part { PartNo="214020210-H", PartName="Seagate ST1000DM010", CategoryId=C("IPC"), MinStock=2, MaxStock=20, ReorderPoint=5, CostPerUnit=0, IsActive=true, DeviceType="ADM" },
                ...
                new Part { PartNo="214010191001", PartName="IPC-014(i3/3.3G/4GM/2* 1T HD)", CategoryId=C("IPC"), MinStock=2, MaxStock=20, ReorderPoint=5, CostPerUnit=0, IsActive=true, DeviceType="ADM" },
                ...
                new Part { PartNo="502010227002", PartName="CRM9250(FS/EN/OD S/4 NRC/UNV/WITH LOCK) Lower unit", CategoryId=C("MDM"), MinStock=2, MaxStock=20, ReorderPoint=5, CostPerUnit=0, IsActive=true, Zone="Lower" },
                new Part { PartNo="301010117", PartName="CRM9250 Main Board", CategoryId=C("MDM"), MinStock=2, MaxStock=20, ReorderPoint=5, CostPerUnit=0, IsActive=true, Zone="Lower", DeviceType="ADM" },
                new Part { PartNo="301010117-H", PartName="CRM9250 Main Board", CategoryId=C("MDM"), MinStock=2, MaxStock=20, ReorderPoint=5, CostPerUnit=0, IsActive=true, Zone="Lower", DeviceType="ADM" },
                new Part { PartNo="301010339", PartName="NV power board", CategoryId=C("MDM"), MinStock=2, MaxStock=20, ReorderPoint=5, CostPerUnit=0, IsActive=true, Zone="Lower" },
                new Part { PartNo="301010339-H", PartName="NV power board", CategoryId=C("MDM"), MinStock=2, MaxStock=20, ReorderPoint=5, CostPerUnit=0, IsActive=true, Zone="Lower", DeviceType="ADM" },
                new Part { PartNo="402020038", PartName="MF08(motor with Cable)", CategoryId=C("MDM"), MinStock=2, MaxStock=20, ReorderPoint=5, CostPerUnit=0, IsActive=true, Zone="Lower" },
                new Part { PartNo="402020038-H", PartName="MF08(motor with Cable)", CategoryId=C("MDM"), MinStock=2, MaxStock=20, ReorderPoint=5, CostPerUnit=0, IsActive=true, Zone="Lower" },
                new Part { PartNo="502010742", PartName="Step Motor Assy(CRM9250/RC2)", CategoryId=C("MDM"), MinStock=2, MaxStock=20, ReorderPoint=5, CostPerUnit=0, IsActive=true, Zone="Lower" },
                new Part { PartNo="502010743", PartName="Step Motor Assy(CRM9250/RC3)", CategoryId=C("MDM"), MinStock=2, MaxStock=20, ReorderPoint=5, CostPerUnit=0, IsActive=true, Zone="Lower" },
                new Part { PartNo="502010744", PartName="Step Motor Assy(CRM9250/RC4)", CategoryId=C("MDM"), MinStock=2, MaxStock=20, ReorderPoint=5, CostPerUnit=0, IsActive=true, Zone="Lower" },
                new Part { PartNo="502010810", PartName="SMHP step motor cable", CategoryId=C("MDM"), MinStock=2, MaxStock=20, ReorderPoint=5, CostPerUnit=0, IsActive=true, Zone="Lower" },
                new Part { PartNo="711060008", PartName="steo motor/STP-60D3007GAN", CategoryId=C("MDM"), MinStock=2, MaxStock=20, ReorderPoint=5, CostPerUnit=0, IsActive=true, Zone="Lower" },
                new Part { PartNo="502011091-H", PartName="RC4DC motor assy-RC4", CategoryId=C("MDM"), MinStock=2, MaxStock=20, ReorderPoint=5, CostPerUnit=0, IsActive=true, Zone="Lower" },
                new Part { PartNo="502011455-H", PartName="Channel main motor assy.", CategoryId=C("MDM"), MinStock=2, MaxStock=20, ReorderPoint=5, CostPerUnit=0, IsActive=true, Zone="Lower" },
                new Part { PartNo="502011088-H", PartName="RC1 Base board DC motor assy", CategoryId=C("MDM"), MinStock=2, MaxStock=20, ReorderPoint=5, CostPerUnit=0, IsActive=true, Zone="Lower" },
                new Part { PartNo="502011089-H", PartName="CRM9250 motor assemblyRC2", CategoryId=C("MDM"), MinStock=2, MaxStock=20, ReorderPoint=5, CostPerUnit=0, IsActive=true, Zone="Lower" },
                new Part { PartNo="502011090-H", PartName="RC3DC motor assy-RC3", CategoryId=C("MDM"), MinStock=2, MaxStock=20, ReorderPoint=5, CostPerUnit=0, IsActive=true, Zone="Lower" },
                new Part { PartNo="401010890-H", PartName="AC connector (female)", CategoryId=C("MDM"), MinStock=2, MaxStock=20, ReorderPoint=5, CostPerUnit=0, IsActive=true, Zone="Lower" },
                new Part { PartNo="502011093-H", PartName="CRM9250 cassette motor assembly RC3", CategoryId=C("MDM"), MinStock=2, MaxStock=20, ReorderPoint=5, CostPerUnit=0, IsActive=true, Zone="Lower" },
                new Part { PartNo="401010892-H", PartName="RC1 connector (female)", CategoryId=C("MDM"), MinStock=2, MaxStock=20, ReorderPoint=5, CostPerUnit=0, IsActive=true, Zone="Lower" },
                new Part { PartNo="401010894-H", PartName="RC2 connector (female)", CategoryId=C("MDM"), MinStock=2, MaxStock=20, ReorderPoint=5, CostPerUnit=0, IsActive=true, Zone="Lower" },
                new Part { PartNo="301010145-H", PartName="ODS control board", CategoryId=C("MDM"), MinStock=2, MaxStock=20, ReorderPoint=5, CostPerUnit=0, IsActive=true, Zone="Lower" },
                new Part { PartNo="401010898-H", PartName="RC4 connector (female)", CategoryId=C("MDM"), MinStock=2, MaxStock=20, ReorderPoint=5, CostPerUnit=0, IsActive=true, Zone="Lower" },
                new Part { PartNo="711060005-H", PartName="Step Motor STP-59D5055GAN", CategoryId=C("MDM"), MinStock=2, MaxStock=20, ReorderPoint=5, CostPerUnit=0, IsActive=true, Zone="Lower" },
                new Part { PartNo="502011457-H", PartName="MC06 (Motor with Cable and Gear)", CategoryId=C("MDM"), MinStock=2, MaxStock=20, ReorderPoint=5, CostPerUnit=0, IsActive=true, Zone="Lower" },
                new Part { PartNo="502011649-H", PartName="MC01(Motor with Cable and Gear)", CategoryId=C("MDM"), MinStock=2, MaxStock=20, ReorderPoint=5, CostPerUnit=0, IsActive=true, Zone="Lower" },
                new Part { PartNo="502011450-H", PartName="MC07", CategoryId=C("MDM"), MinStock=2, MaxStock=20, ReorderPoint=5, CostPerUnit=0, IsActive=true, Zone="Lower" },
                new Part { PartNo="502011092-H", PartName="RC2 motor assy_CRM9250", CategoryId=C("MDM"), MinStock=2, MaxStock=20, ReorderPoint=5, CostPerUnit=0, IsActive=true, Zone="Lower" },
                new Part { PartNo="502011454-H", PartName="MC02(with Cable and Gear)", CategoryId=C("MDM"), MinStock=2, MaxStock=20, ReorderPoint=5, CostPerUnit=0, IsActive=true, Zone="Lower" },
                new Part { PartNo="502011094-H", PartName="CRM9250 cassette motor assembly RC4", CategoryId=C("MDM"), MinStock=2, MaxStock=20, ReorderPoint=5, CostPerUnit=0, IsActive=true, Zone="Lower" },
                new Part { PartNo="401010896-H", PartName="RC3 connector (female)", CategoryId=C("MDM"), MinStock=2, MaxStock=20, ReorderPoint=5, CostPerUnit=0, IsActive=true, Zone="Lower" },
                new Part { PartNo="401010890", PartName="AC/XS11", CategoryId=C("MDM"), MinStock=2, MaxStock=20, ReorderPoint=5, CostPerUnit=0, IsActive=true, Zone="Lower" },
                new Part { PartNo="401010892", PartName="RC1/XS10", CategoryId=C("MDM"), MinStock=2, MaxStock=20, ReorderPoint=5, CostPerUnit=0, IsActive=true, Zone="Lower" },
                new Part { PartNo="401010894", PartName="RC2/XS12", CategoryId=C("MDM"), MinStock=2, MaxStock=20, ReorderPoint=5, CostPerUnit=0, IsActive=true, Zone="Lower" },
                new Part { PartNo="401010896", PartName="RC3/XS14", CategoryId=C("MDM"), MinStock=2, MaxStock=20, ReorderPoint=5, CostPerUnit=0, IsActive=true, Zone="Lower" },
                new Part { PartNo="401010898", PartName="RC4/XS16", CategoryId=C("MDM"), MinStock=2, MaxStock=20, ReorderPoint=5, CostPerUnit=0, IsActive=true, Zone="Lower" },
                new Part { PartNo="502011091", PartName="RC4DC motor assy-RC4", CategoryId=C("MDM"), MinStock=2, MaxStock=20, ReorderPoint=5, CostPerUnit=0, IsActive=true, Zone="Lower" },
                new Part { PartNo="502011090", PartName="RC3DC motor assy-RC3", CategoryId=C("MDM"), MinStock=2, MaxStock=20, ReorderPoint=5, CostPerUnit=0, IsActive=true, Zone="Lower" },
                new Part { PartNo="502011089", PartName="CRM9250 motor assemblyRC2", CategoryId=C("MDM"), MinStock=2, MaxStock=20, ReorderPoint=5, CostPerUnit=0, IsActive=true, Zone="Lower" },
                new Part { PartNo="502011088", PartName="RC1 Base board DC motor assy", CategoryId=C("MDM"), MinStock=2, MaxStock=20, ReorderPoint=5, CostPerUnit=0, IsActive=true, Zone="Lower" },
                ...
                new Part { PartNo="502010218003", PartName="CR9250, NE temporary storage assembly", CategoryId=C("NF/NE Sensor"), MinStock=2, MaxStock=20, ReorderPoint=5, CostPerUnit=0, IsActive=true, DeviceType="ADM" },
                new Part { PartNo="301010116", PartName="CRM9250 Upper Board", CategoryId=C("NF/NE Sensor"), MinStock=2, MaxStock=20, ReorderPoint=5, CostPerUnit=0, IsActive=true, DeviceType="ADM" },
                new Part { PartNo="301010116-H", PartName="CRM9250 Upper Board", CategoryId=C("NF/NE Sensor"), MinStock=2, MaxStock=20, ReorderPoint=5, CostPerUnit=0, IsActive=true, DeviceType="ADM" },
                ...
                new Part { PartNo="502010798", PartName="MPS TOMOR PE01", CategoryId=C("NF/NE Sensor"), MinStock=2, MaxStock=20, ReorderPoint=5, CostPerUnit=0, IsActive=true, DeviceType="ADM" },
                new Part { PartNo="502010798-H", PartName="MPS TOMOR PE01", CategoryId=C("NF/NE Sensor"), MinStock=2, MaxStock=20, ReorderPoint=5, CostPerUnit=0, IsActive=true, DeviceType="ADM" },
                new Part { PartNo="502010799", PartName="LPS MOTOR PE03", CategoryId=C("NF/NE Sensor"), MinStock=2, MaxStock=20, ReorderPoint=5, CostPerUnit=0, IsActive=true, DeviceType="ADM" },
                new Part { PartNo="502010799-H", PartName="LPS MOTOR PE03", CategoryId=C("NF/NE Sensor"), MinStock=2, MaxStock=20, ReorderPoint=5, CostPerUnit=0, IsActive=true, DeviceType="ADM" },
                ...
                new Part { PartNo="502010217", PartName="Note feeder Lower", CategoryId=C("NV Module"), MinStock=2, MaxStock=20, ReorderPoint=5, CostPerUnit=0, IsActive=true, DeviceType="ADM" },
                new Part { PartNo="502010217-H", PartName="Note feeder Lower", CategoryId=C("NV Module"), MinStock=2, MaxStock=20, ReorderPoint=5, CostPerUnit=0, IsActive=true, DeviceType="ADM" },
                ...
                new Part { PartNo="502010216001", PartName="CRM9250 recycling shaft assembly", CategoryId=C("NV Module"), MinStock=2, MaxStock=20, ReorderPoint=5, CostPerUnit=0, IsActive=true, DeviceType="ADM" },
                new Part { PartNo="502010284", PartName="Note Feeder Upper Module(CRM9250)", CategoryId=C("NV Module"), MinStock=2, MaxStock=20, ReorderPoint=5, CostPerUnit=0, IsActive=true, DeviceType="ADM" },
                new Part { PartNo="502010284-H", PartName="Note Feeder Upper Module(CRM9250)", CategoryId=C("NV Module"), MinStock=2, MaxStock=20, ReorderPoint=5, CostPerUnit=0, IsActive=true, DeviceType="ADM" },
                ...
                new Part { PartNo="502010216-H", PartName="Slot Shutter (CRM9250-ss-001)", CategoryId=C("NV Module"), MinStock=2, MaxStock=20, ReorderPoint=5, CostPerUnit=0, IsActive=true, DeviceType="ADM" },
                new Part { PartNo="502010216", PartName="SHUTTER ASSY (CRM9250)", CategoryId=C("NV Module"), MinStock=2, MaxStock=20, ReorderPoint=5, CostPerUnit=0, IsActive=true, DeviceType="ADM" },
                ...
                new Part { PartNo="502010292002-H", PartName="Note Validator Module(2nd generation)", CategoryId=C("NV Module"), MinStock=2, MaxStock=20, ReorderPoint=5, CostPerUnit=0, IsActive=true, DeviceType="CDM" },
                ...
                new Part { PartNo="208010063-H", PartName="Power Supply GPAD431M36-1E", CategoryId=C("Power Supply"), MinStock=2, MaxStock=20, ReorderPoint=5, CostPerUnit=0, IsActive=true, DeviceType="CDM" },
                new Part { PartNo="208010006-H", PartName="Power Supply(AD321M36-4M1320W)", CategoryId=C("Power Supply"), MinStock=2, MaxStock=20, ReorderPoint=5, CostPerUnit=0, IsActive=true, DeviceType="CDM" },
                new Part { PartNo="208010065-H", PartName="Power Supply(GPAD311M36-4B)", CategoryId=C("Power Supply"), MinStock=2, MaxStock=20, ReorderPoint=5, CostPerUnit=0, IsActive=true, DeviceType="CDM" },
                new Part { PartNo="207040197", PartName="THERMAL RECEIPT PRINTER(TRP-006R)", CategoryId=C("Printer"), MinStock=2, MaxStock=20, ReorderPoint=5, CostPerUnit=0, IsActive=true, DeviceType="ADM" },
                ...
                new Part { PartNo="301010904", PartName="TRP-006R RECEIPT PRINTER CONTROL BOARD", CategoryId=C("Printer"), MinStock=2, MaxStock=20, ReorderPoint=5, CostPerUnit=0, IsActive=true, DeviceType="ADM" },
                new Part { PartNo="502015969", PartName="TRP-006R printer sensor and motor cable", CategoryId=C("Printer"), MinStock=2, MaxStock=20, ReorderPoint=5, CostPerUnit=0, IsActive=true, DeviceType="ADM" },
                new Part { PartNo="711010513", PartName="Thermal printer head/PT72AS-A/Pratt", CategoryId=C("Printer"), MinStock=2, MaxStock=20, ReorderPoint=5, CostPerUnit=0, IsActive=true, DeviceType="ADM" },
                ...
                new Part { PartNo="207040007005-H", PartName="TRP-003R", CategoryId=C("Printer"), MinStock=2, MaxStock=20, ReorderPoint=5, CostPerUnit=0, IsActive=true, DeviceType="CDM" },
                ...
                new Part { PartNo="202020228", PartName="RF-2G Creator", CategoryId=C("Card Reader"), MinStock=2, MaxStock=20, ReorderPoint=5, CostPerUnit=0, IsActive=true, DeviceType="ADM" },
                ...
                new Part { PartNo="216020190", PartName="TAIZHOU LOCK(8K-2)", CategoryId=C("Safe Lock"), MinStock=2, MaxStock=20, ReorderPoint=5, CostPerUnit=0, IsActive=true, DeviceType="ADM" },
                ...
                new Part { PartNo="215040005-H", PartName="15\" Touch Screen(TSC-004TL6B15D2WS)", CategoryId=C("Screen Monitor"), MinStock=2, MaxStock=20, ReorderPoint=5, CostPerUnit=0, IsActive=true, DeviceType="CDM" },
                ...
                new Part { PartNo="502021657", PartName="UNV MODULE", CategoryId=C("NV Module"), MinStock=2, MaxStock=20, ReorderPoint=5, CostPerUnit=0, IsActive=true, DeviceType="ADM" },
                new Part { PartNo="502017581", PartName="9250-UNV(MDT+HEC)", CategoryId=C("NV Module"), MinStock=2, MaxStock=20, ReorderPoint=5, CostPerUnit=0, IsActive=true, DeviceType="ADM" },
                new Part { PartNo="502010237004", PartName="CRM9250(FS/EN/OD S/4 NRC/UNV/WITH LOCK) Upper unit", CategoryId=C("MDM"), MinStock=2, MaxStock=20, ReorderPoint=5, CostPerUnit=0, IsActive=true, Zone="Upper", DeviceType="ADM" },
                new Part { PartNo="725030904002", PartName="CRM9250 upper unit lock cover (including 725030903 lock bolt and 720110171 key lock)", CategoryId=C("MDM"), MinStock=2, MaxStock=20, ReorderPoint=5, CostPerUnit=0, IsActive=true, Zone="Upper", DeviceType="ADM" },
                new Part { PartNo="502010237002", PartName="CRM9250 (FS/EN/OD S/4 NRC/UNV/WITH LOCK) Upper unit", CategoryId=C("MDM"), MinStock=2, MaxStock=20, ReorderPoint=5, CostPerUnit=0, IsActive=true, Zone="Upper", DeviceType="ADM" },
                ...
                new Part { PartNo="9103-53862XG1-00", PartName="UPS", CategoryId=C("Power Supply"), MinStock=2, MaxStock=20, ReorderPoint=5, CostPerUnit=0, IsActive=true, DeviceType="ADM" },
                ...
                new Part { PartNo="214020393", PartName="SATA (ST1000DM014/3.5 inch/7200R/1T/256M)", CategoryId=C("IPC"), MinStock=2, MaxStock=20, ReorderPoint=5, CostPerUnit=0, IsActive=true, DeviceType="ADM,ATM" },
                ...
                new Part { PartNo="214020669", PartName="SSD(V310 1024G-4fLC20/2.5)#", CategoryId=C("IPC"), MinStock=2, MaxStock=20, ReorderPoint=5, CostPerUnit=0, IsActive=true, DeviceType="ATM" },
                new Part { PartNo="214030189", PartName="Kingston memory(KVR16N11S 8/4/)", CategoryId=C("IPC"), MinStock=2, MaxStock=20, ReorderPoint=5, CostPerUnit=0, IsActive=true, DeviceType="ATM" },
                new Part { PartNo="215050240", PartName="15-inch DISPLAY(MON-1501/ NLT/NCB01)", CategoryId=C("Screen Monitor"), MinStock=2, MaxStock=20, ReorderPoint=5, CostPerUnit=0, IsActive=true, DeviceType="ADM" },
                new Part { PartNo="301011993", PartName="CRM9250 UPPER CONTROL BOARD(GD32)", CategoryId=C("PCB"), MinStock=2, MaxStock=20, ReorderPoint=5, CostPerUnit=0, IsActive=true, DeviceType="ADM" },
                new Part { PartNo="301011994", PartName="CRM9250 MAIN CONTROL BOARD(GD32)", CategoryId=C("PCB"), MinStock=2, MaxStock=20, ReorderPoint=5, CostPerUnit=0, IsActive=true, DeviceType="ADM" },
                ...
                new Part { PartNo="3101173TE-1K", PartName="UPS Syndome", CategoryId=null, MinStock=2, MaxStock=20, ReorderPoint=5, CostPerUnit=0, IsActive=true, DeviceType="CDM" },
                ...
                new Part { PartNo="215050240-GA", PartName="15-inch DISPLAY(MON-1501/NLT/NCB01)", CategoryId=null, MinStock=2, MaxStock=20, ReorderPoint=5, CostPerUnit=0, IsActive=true, DeviceType="CDM" },
                ...
                new Part { PartNo="214020527-GA", PartName="HARD DISK(AirDisk/AMF10/3.0 INCH/256G)", CategoryId=null, MinStock=2, MaxStock=20, ReorderPoint=5, CostPerUnit=0, IsActive=true, DeviceType="ATM" },
                ...
                new Part { PartNo="214020503-GA", PartName="HDD(WD10EZEX/7200RPM/1TB)", CategoryId=null, MinStock=2, MaxStock=20, ReorderPoint=5, CostPerUnit=0, IsActive=true, DeviceType="ATM" },
